...
namespace BigProject.GUI
{
    public partial class FormGiangvien : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLSinhVienDataSet.Giangvien' table. You can move, or remove it, as needed.
            this.giangvienTableAdapter.Fill(this.qLSinhVienDataSet.Giangvien);
            ShowCombox();
